...
import { qtiTransformItem } from '@citolab/qti-components';
  ...
  const items = useRef([
    {
      name: 'choice', items: [
        ...
        { name: 'inline choice math', href: '/inline_choice_math.xml', current: false },
  ...
  return (
    <div className="grid md:grid-cols-2 gap-4 bg-gray-200">
      <Panel title='QTI 3' actionComponents={[
        ...
        {state.isConverting ? <div className="absolute top-0 left-0 w-full h-full bg-gray-200 bg-opacity-50 flex justify-center items-center">
      ...
      <Panel title='QTI Preview' actionComponents={[<div className='flex gap-2'>
        <div>
          <button
            id="correct-button"
            type="button"
            ...
            onClick={() => {
              ...
              const assessmentItem = container?.shadowRoot?.querySelector('qti-assessment-item') as QtiAssessmentItem;
              if (assessmentItem) {
        ...
        <div>
          <button
            ...
            onClick={() => {
              ...
              window.open('https://github.com/Citolab/qti-components', '_blank');
            }}
            className="inline-flex items-center gap-x-1.5 rounded-md bg-citolab-600 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-citolab-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-citolab-600"
          >
          ...
          <Tooltip isOpen={true} data-tooltip-id={'info-button'} content={'Preview generated by @citolab\\qti-componets: https://github.com/Citolab/qti-components'} />
        </div>
      </div>
        ...
        <>
          ...
          {state.errorMessage ? <div className="w-full h-full bg-red-200 bg-opacity-50 flex justify-center items-center">
            <div className="text-red-900">Oops, an error occurred: {state.errorMessage}</div>
          </div> : null}
        </>
      </Panel>
    </div>
